        ...
        <div class="d-flex">
            <div class="dropdown d-sm-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="{{ route('system.switchLang','az') }}" class="dropdown-item notify-item">
                        <img src="{{ asset('backend/images/flags/az.png')}}" class="me-1" height="12">
                        <span class="align-middle">Azərbaycan</span>
                    </a>
                    <a href="{{ route('system.switchLang','en') }}" class="dropdown-item notify-item">
                        <img src="{{ asset('backend/images/flags/en.jpg')}}" class="me-1" height="12">
                        <span class="align-middle">English</span>
                    </a>
                    <a href="{{ route('system.switchLang','ru') }}" class="dropdown-item notify-item">
